                            ...
                            <div class="row">
                                <div class="col-md-4 card-box">
                                    ...
                                    <form role="form" id="registerForm_App">
                                        ...
                                        <div class="form-group">
                                            <label for="headerColor">CSS Header Color: </label>
                                            <div id="cp2" class="input-group colorpicker-component">
                                                <input type="text" name="header_color" value="{{lapp()->header_color}}" class="form-control" />
                                                <span class="input-group-addon"><i></i></span>
                                            </div>
                                        </div>

                                         <div class="form-group">
                                            <label for="headerColor"> {{checkedIt() == "" ? 'Enable' : 'Disable'}} DataTables Tools: ('copy', 'csv', 'excel', 'pdf', 'print') </label><br/><br/>
                                            <input type="checkbox" {!!checkedIt()!!} value="enabled" name="datatablesTools" data-plugin="switchery" data-color="#1AB394" data-secondary-color="#ED5565" />
                                        </div>
...
<script type="text/javascript" src="{{url('BACKEND/js/colorpicker.js')}}"></script>
